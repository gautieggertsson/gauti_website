...
summary:
editPost:
    URL: "https://www.sciencedirect.com/science/article/pii/S1094202521000296?via%3Dihub"
...
+ [Paper](https://ideas.repec.org/a/red/issued/20-47.html)
+ [Local PDF](ZLB_Toolkit.pdf)
...
```BibTeX
@article{eggertsson2021toolkit,
  title={A toolkit for solving models with a lower bound on interest rates of stochastic duration},
  author={Eggertsson, Gauti B and Egiev, Sergey K and Lin, Alessandro and Platzer, Josef and Riva, Luca},
